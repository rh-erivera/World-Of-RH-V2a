<template>
    <div class="container">
        ...
        <div class="slideshow">
            ...
            <div class="col-2" id="col2" ref="col2"></div>
            <div class="col-3" id="col3" ref="col3"></div>
        </div>
        <div class="menu">
            <div class="menu-1">
                <p class="the">The</p>
...
export default {
    ...
    methods: {
        startPlaceSlideShow() {
            ...
            this.$refs.col1.style.backgroundImage = 'url(\'/design15/col1/15_bg_places_0'+this.i1+'.jpg\')';
        ...
        startProductSlideShow() {
            ...
            this.$refs.col2.style.backgroundImage = 'url(\'/design15/col2/15_bg_products_0'+this.i2+'.jpg\')';
        ...
        startSpaceSlideShow() {
            ...
            this.$refs.col3.style.backgroundImage = 'url(\'/design15/col3/15_bg_spaces_0'+this.i3+'.jpg\')';
